                    ...
                    <form action="./service/cart.php" method="post">
                        ...
                        <div class="card">
                            ...
                            ?>
                                <tr>
                                    <td class="item_col1">
                                        <img src="../../_system/upload/<?= $fetch_cart -> img_m ?>" class="rounded-circle img-thumbnail" style="width:75px; height:75px; object-fit:cover" alt="">
                                    ...
                                    <td class="">
                                        <div class="flex-container">
                                            <?php if($fetch_cart -> c_count > 1){ ?>
                                                <a href="./service/cart.php?delItem=1&id=<?= $fetch_cart -> id_c; ?>" class="nav-link">-</a>
                                            <?php } ?>
                                            <h5><?= $fetch_cart -> c_count?></h5>
                                            <a href="./service/cart.php?plusItem=1&id=<?= $fetch_cart -> id_c; ?>" class="nav-link">+</a>
                                        </div>
                                    </td>
                                    <td class="">
                                        <div class="flex-container">
