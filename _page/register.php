                    ...
                    <div class="col-8">
                        <div class="fading-box">
                            <div class="card shadow" style="border-radius: 8px;">
                                <div class="row">
                                    <div class="col-4">
                                        <img src="./../bs/img/img1.jpg" class="img-fluid h-100 w-100" alt="..." style="border-radius: 8px;">
                                    </div>
                                    <div class="col-8">
                                        <form action="" method="post">
                                            <div class="form-container m-4">
                                                ...
                                                <input type="text" placeholder="Email" name="email" class="form-control mb-3 shadow-sm" style="border-radius:28px" id="">
                                                <hr>
                                                <input type="text" placeholder="Password" name="password" class="form-control mb-3 shadow-sm" style="border-radius:20px" id="">
                                                <input type="text" placeholder="Password Confirm" name="password_con" class="form-control mb-3 shadow-sm" style="border-radius:20px" id="">
                                                <div class="row">
                                                    <div class="col">
                                                        <button type="submit" class="btn btn-outline-primary" name="register" style="border-radius:20px">สมัครสมาชิก</button>
                                                    </div>
                                                    <div class="col mt-auto text-center"><a href="./login.php" class="link-primary">มีบัญชีผู้ใช้งานแล้ว </a></div>
                                                </div>
                                            </div>
                                        </form>
